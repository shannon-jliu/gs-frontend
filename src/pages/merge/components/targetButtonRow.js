...
const TargetButtonRow = ({ type, offaxis, isSaved, saveable, save, deletable, deleteFn }) => (
  <div className='row'>
    {/*Save button */}
    <div className='button-container input-field col s6'>
      <a onClick={save} className={(saveable ? '' : 'grey lighten-2 ') + 'waves-effect waves-light btn'} href='/#'>
        {isSaved ? 'Update' : 'Save'}
      </a>
    </div>
    {/*Delete button */}
