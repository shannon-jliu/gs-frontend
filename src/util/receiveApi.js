...
export const AssignmentGetRequests = {
  getAllAssignments: function (successCallback, failureCallback) {
    $.get('/api/v1/assignment').done(successCallback).fail(failureCallback)
  },
...
export const SettingsGetRequests = {
  ...
  getCameraSettingCapturing: function (successCallback, failureCallback) {
    SettingsGetRequests.getSetting(
      '/api/continuous-capture',
      successCallback,
      failureCallback
    )
  },
  ...
  getCameraGimbalSetting: function (successCallback, failureCallback) {
    SettingsGetRequests.getSetting(
      '/api/v1/settings/camera_gimbal/recent',
      successCallback,
      failureCallback
    )
  },
  ...
  getFiveTargetsSettings: function (successCallback, failureCallback) {
    SettingsGetRequests.getSetting(
      '/api/v1/settings/five_targets/recent',
      successCallback,
      failureCallback
    )
  },
